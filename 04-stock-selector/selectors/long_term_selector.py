...
class LongTermSelector:
    ...
    def analyze_single_stock(self, code: str) -> Dict:
        ...
        评分策略（满分100分）：
          1. 趋势评分     (30分) — 基于MA20/MA60均线多头排列、价格位置判断趋势健康度
          2. 动量评分     (15分) — 5日/20日涨跌幅，正收益加分，衡量近期价格动能
          3. 量能评分     (15分) — OBV趋势 + 量比（0.8~2.0为合理区间）
          4. 趋势强度     (10分) — ADX>25表示趋势明显，+DI>-DI表示多头占优
          5. 波动率评分   (10分) — 年化波动率15~35%为最优，过高或过低均降分
          6. 乖离率评分   (10分) — MA20乖离率-10%~+15%为健康区间，防止追高
          7. 资金流评分   (10分) — 主力净流入为正得满分，轻微流出得一半分
